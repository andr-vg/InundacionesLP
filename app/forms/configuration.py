...
class ConfigurationForm(FlaskForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ordered_by.choices = [
            ("ascendente", "Ascendente"),
            ("descendente", "Descendente"),
        ]
        self.ordered_by.data = kwargs["ordered_by"]
        self.css_private.choices = [
            ("private1.css", "Tema Principal"),
            ("private2.css", "Tema Oscuro"),
            ("private3.css", "Tema Claro"),
        ]
        self.css_private.data = kwargs["css_private"]
        self.css_public.choices = [
            ("private1.css", "Tema Principal"),
            ("private2.css", "Tema Oscuro"),
            ("private3.css", "Tema Claro"),
        ]
    ...
    def validate_elements_per_page(form, field):
        ...
        try:
            ...
            form.elements_per_page.errors = (
                validators.ValidationError("Debe ingresar un numero entre 1 y 30"),
            )
    ...
    def validate_ordered_by(form, field):
        ...
        if not (field.data in choices):
            form.ordered_by.errors = (
                validators.ValidationError("Elija una opcion del listado"),
            )
